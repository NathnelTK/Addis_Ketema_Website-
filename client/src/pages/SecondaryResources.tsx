  ...
  const ethiopianResources = [
    {
      ...
      description: 'Official secondary curriculum and textbooks',
    },
    {
      name: 'Ethiopian Education Resources',
      url: 'https://www.eenet.org.uk',
      description: 'Comprehensive educational materials for secondary students',
    },
    {
      name: 'Open Educational Resources',
      url: 'https://www.oer.org',
      description: 'Free and open-source learning materials',
    },
  ];
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-16">
        <div className="container">
          <div className="flex items-center gap-3 mb-4">
            <Link href="/resources">
              <a className="text-blue-100 hover:text-white">Resources</a>
            </Link>
            <span className="text-blue-100">/</span>
            <span>Secondary School</span>
          </div>
          <h1 className="text-5xl font-bold mb-4">Secondary School Resources</h1>
          <p className="text-xl text-blue-100">Grades 9-12 Advanced Learning Materials</p>
        </div>
      </section>
            ...
            {subjects.map((subject, idx) => (
              <div key={idx} className="highlight-card">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  {subject === 'Mathematics' && 'Advanced algebra, calculus, geometry, and mathematical analysis.'}
                  {subject === 'Physics' && 'Mechanics, thermodynamics, electromagnetism, and modern physics.'}
                  {subject === 'Chemistry' && 'Organic chemistry, inorganic chemistry, and chemical reactions.'}
                  {subject === 'Biology' && 'Cell biology, genetics, ecology, and human physiology.'}
                  {subject === 'English' && 'Literature analysis, advanced writing, and communication skills.'}
                  {subject === 'History' && 'World history, African history, and Ethiopian civilization.'}
                  {subject === 'Geography' && 'Physical geography, human geography, and environmental studies.'}
